...
#define kChatColor [UIColor colorWithRed:0.0f/255.0f green:195.0f/255.0f blue:233.0f/255.0f alpha:1.0f]
#define kMailColor [UIColor colorWithRed:16.0f/255.0f green:122.0f/255.0f blue:208.0f/255.0f alpha:1.0f]
#define kCallColor [UIColor colorWithRed:129.0f/255.0f green:197.0f/255.0f blue:86.0f/255.0f alpha:1.0f]
...
-(id)initWithFrame:(CGRect)frame normalImage:(UIImage*)passiveImage andPressedImage:(UIImage*)activeImage withScrollview:(UIScrollView*)scrView
{
    ...
    if (self)
    {
        ...
        _iconArray = [NSArray arrayWithObjects:kFloatingChatICon,kFloatingMailIcon,kFloatingCallIcon, nil];
        
        _colorArray = [NSArray arrayWithObjects:kChatColor, kMailColor, kCallColor, nil];
        
        windowView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, kScreenWidth, kScreenHeight)];
       ...
       // _menuTable = [[UITableView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/4, 0, 0.75*SCREEN_WIDTH,SCREEN_HEIGHT - (SCREEN_HEIGHT - CGRectGetMaxY(self.frame))+64 )];
        ...
        _menuTable.tableHeaderView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH/3, frame.size.height+6)];
...
-(void) setupButton
{
    ...
    _bgView.backgroundColor = [UIColor colorWithWhite:0.2 alpha:0.6];
    _bgView.alpha = 0;
    ...
    //Uncomment to make bacgkround blurry
  //  _bgView = vsview;
...
//        cell.title.text = [[_menuItemSet allValues]objectAtIndex:indexPath.row];
    ...
    cell.imgView.image = [UIImage imageWithIcon:[_iconArray objectAtIndex:indexPath.row] backgroundColor:[UIColor clearColor] iconColor:[UIColor whiteColor] andSize:CGSizeMake(20,20)];
    cell.imageHolder.backgroundColor = [_colorArray objectAtIndex:indexPath.row];
